    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('obozy.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" maxlength="500" type="text" class="form-control @error('description') is-invalid @enderror" name="description" autofocus>{{old('description')}}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="personLimit" type="number" min="0" class="form-control @error('personLimit') is-invalid @enderror" name="personLimit" value="{{ old('personLimit') }}" required autocomplete="personLimit" autofocus>
